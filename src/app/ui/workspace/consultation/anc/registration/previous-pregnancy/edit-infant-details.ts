namespace mrs.ui {
    ...
    class Controller implements ng.IController {
        ...
        close = () => {
            this.state.go("consultation.management.ancregistration.previousPregnancies.edit", {previousAncId: this.ancId});
        }
    ...
    class Component implements ng.IComponentOptions {
        ...
        constructor(
            public templateUrl = "app/ui/workspace/consultation/anc/registration/previous-pregnancy/edit-infant-details.html",
    ...
    app.component("mrsConsultationPatientAncPreviousPregnanciesEditInfantLayout", new Component());
