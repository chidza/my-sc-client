namespace mrs.ui {
    ...
    class Controller implements IPersonInvestigationList {
        ...
        onAdd = () => {
            this.state.go("consultation.management.ancregistration.investigationHistory.add");

        }

        onEdit = (id: string) => {
            this.personInvestigationService.get(id).then((response) => {
                this.state.go("consultation.management.ancregistration.investigationHistory.edit", { personId: this.personId, personInvestigationId: id, investigationId: response.investigationId });
    ...
    class Component implements ng.IComponentOptions {
        ...
        constructor(
            public templateUrl = "app/ui/workspace/consultation/anc/registration/investigation-history/list.html",
    ...
    app.component("mrsConsultationAncDeliveryInvestigationHistoryListLayout", new Component());
