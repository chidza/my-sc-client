namespace mrs.ui {
    ...
    class Controller implements ng.IController {
        ...
        close = () => {
            this.state.go("consultation.management.pnc.previousPregnancies.edit", {previousAncId: this.ancId});
        }
    ...
    class Component implements ng.IComponentOptions {
        ...
        constructor(
            public templateUrl = "app/ui/workspace/consultation/pnc/previous-pregnancy/edit-infant-details.html",
    ...
    app.component("mrsConsultationPatientPncPreviousPregnanciesEditInfantLayout", new Component());
