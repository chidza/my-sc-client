namespace mrs.ui {
    ...
    class Component implements ng.IComponentOptions {
        ...
        constructor(
            public templateUrl = "app/ui/workspace/consultation/delivery/monitoring/investigations/tests-edit.html",
            public controllerAs = "vm",
            public controller = Controller) { }

    }

    app.component("mrsConsultationPatientDeliveryMonitoringInvestigationTestEditLayout", new Component());
