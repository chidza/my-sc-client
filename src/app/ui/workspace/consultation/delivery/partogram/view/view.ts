namespace mrs.ui {
    ...
    class Component implements ng.IComponentOptions {
        ...
        constructor(
            public templateUrl = "app/ui/workspace/consultation/delivery/partogram/view/view.html",
    ...
    app.component("mrsConsultationPatientDeliveryPartogramViewLayout", new Component());
