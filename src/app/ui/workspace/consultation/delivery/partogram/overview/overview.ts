namespace mrs.ui {
    ...
    class Controller implements ng.IController {
        ...
        admit = () => {
         ...
         addNew = (deliveryPartogramId: string) => {
             this.state.go("consultation.management.deliveryPartogram.record", { deliveryId : this.deliveryId, deliveryPartogramId: deliveryPartogramId });
        }
    ...
    class Component implements ng.IComponentOptions {
        ...
        constructor(
            public templateUrl = "app/ui/workspace/consultation/delivery/partogram/overview/overview.html",
            public controllerAs = "vm",
            public controller = Controller) { }

    }

    app.component("mrsConsultationPatientDeliveryPartogramOverviewLayout", new Component());
