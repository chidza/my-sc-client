namespace mrs.ui {
    ...
    class Component implements ng.IComponentOptions {
        ...
        constructor(
            public templateUrl = "app/ui/workspace/consultation/delivery/partogram/partogram-notes/add.html",
    ...
    app.component("mrsConsultationPatientDeliveryPartogramPartogramNoteAddLayout", new Component());
