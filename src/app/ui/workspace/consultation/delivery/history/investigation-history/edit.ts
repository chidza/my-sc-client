namespace mrs.ui {
    ...
    class Controller implements ng.IController {
        ...
        onCancel = () => {
            this.state.go("consultation.management.deliveryRegistration.investigation.list");
    ...
    class Component implements ng.IComponentOptions {
        ...
        constructor(
            public templateUrl = "app/ui/workspace/consultation/delivery/history/investigation-history/edit.html",
    ...
    app.component("mrsConsultationPatientDeliveryInvestigationHistoryEditLayout", new Component());
