namespace mrs.ui {
    ...
    class Component implements ng.IComponentOptions {
        ...
        constructor(
            public templateUrl = "app/ui/workspace/consultation/partogram/partogram-notes/edit.html",
    ...
    app.component("mrsConsultationPatientPartogramPartogramNoteEditLayout", new Component());
