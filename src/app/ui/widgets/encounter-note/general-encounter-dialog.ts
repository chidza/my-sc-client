namespace mrs.ui {
    ...
    class Controller implements IEncounterNoteDialog {
        ...
        $onInit = () => {
            console.log(this.encounterNoteId , "this.encounterNoteId");
    ...
    class Component implements ng.IComponentOptions {
        ...
        constructor(
            public templateUrl = "app/ui/widgets/encounter-note/general-encounter-dialog.html",
    ...
    app.component("mrsGeneralEncounterNoteDialog", new Component());
