...
namespace mrs.ui {
  ...
  class Controller implements IPncQuestionaire {
    ...
    init = () => {
      ...
      if (this.essentialBabyCareId) {
        this.essentialBabiesCareService.getessentialBabiesCareFeedingOptions(this.essentialBabyCareId).then((response) => {
    ...
    save = (item: data.IPncQuestionaire, event: any) => {
      if (event.target.checked) {
        this.essentialBabiesCareService.addEssentialBabiesCareFeedingOptions(this.essentialBabyCareId, item.id).then((response) => {

        }, (error) => {
          console.log(error);
        });
      } else {
        this.essentialBabiesCareService.removeEssentialBabiesCareFeedingOptions(this.essentialBabyCareId, item.id).then((response) => {
  ...
  class Component implements ng.IComponentOptions {
    ...
    constructor(
      public templateUrl = "app/ui/widgets/essential-care-for-babies-feeding-options/dialog-feeding-option.html",
  ...
  app.component("mrsEssentialBabyCareFeedingOptionQuestionaireDialog", new Component());
