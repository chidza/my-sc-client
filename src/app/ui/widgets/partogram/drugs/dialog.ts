namespace mrs.ui {
  ...
  interface IPartogramDrugDialog extends ng.IController {
    closed: () => void;
    saved: (personMedicationId: Object) => void;
  }

  class Controller implements IPartogramDrugDialog {
  ...
  class Component implements ng.IComponentOptions {
    ...
    constructor(
      public templateUrl = "app/ui/widgets/partogram/drugs/dialog.html",
  ...
  app.component("mrsPartogramDrugDialog", new Component());
