namespace mrs.ui {
    ...
    class Controller implements ng.IController {
        ...
        static $inject = ["PersonComplaintService", "DTOptionsBuilder", "DTColumnBuilder"];
        ...
        cb = (data: any, callback: any, settings: any) => {
            ...
            this.personComplaintService.getPersonHistory(this.personId, {
        ...
        $onInit = () => {
            ...
            this.dtColumns = [
                ...
                this.columns.newColumn("duration").withTitle("Duration In Days")
            ];
        }
    }
    ...
    class Component implements ng.IComponentOptions {
        ...
        constructor(
            public templateUrl = "app/ui/widgets/overview/complaint/history.html",
    ...
    app.component("mrsPersonHistoryComplaintList", new Component());
