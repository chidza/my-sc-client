namespace mrs.ui {
  ...
  class Component implements ng.IComponentOptions {
    ...
    constructor(
      public templateUrl = "app/ui/widgets/overview/diagnosis/encounter.html",
  ...
  app.component("mrsPersonEncounterDiagnosisList", new Component());
