namespace mrs.ui {
    ...
    class Controller implements ng.IController {
        ...
        static $inject = ["PersonHealthEducationService", "DTOptionsBuilder", "DTColumnBuilder"];
        ...
        cb = (data: any, callback: any, settings: any) => {
            ...
            this.personHealthEducationService.getPersonHistory(this.personId, {
        ...
        $onInit = () => {
            ...
            this.dtColumns = [
                ...
                this.columns.newColumn("type").withTitle("Type")
            ];
        }
    }
    ...
    class Component implements ng.IComponentOptions {
        ...
        constructor(
            public templateUrl = "app/ui/widgets/overview/health-education/history.html",
    ...
    app.component("mrsPersonHistoryHealthEducationList", new Component());
