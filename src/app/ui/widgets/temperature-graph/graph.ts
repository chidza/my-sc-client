namespace mrs.ui {
    ...
    interface ITemperatureGraph extends ng.IController {

    }

    class Controller implements ITemperatureGraph {
        ...
        ActivePhaseTemperature: Array<data.ILaborActivePhaseVitalList>;
        ...
        constructor(
            ...
            private getTemperatureForActiveLabourStageService: data.ILaborActivePhaseVitalService,
                ...
                this.deliveryService.getActivePhase(this.deliveryId).then((response) => {
                    ...
                    if (this.activePhaseDateTimes) {
                        ...
                        if (this.dateStartActive) {
                         /*   this.getTemperatureForActiveLabourStageService.getVitalIntervals(this.deliveryId, this.personId, this.vitalId, this.dateStartActive, this.dateEndActive).then((response) => {
                                // got vitals now i have to package them in arrays by name: 
                              //  this.orderTemperatureByName(response);
                            });*/
                        }
                    }
                });
        ...
        orderTemperatureByName = (vitals: Array<data.ILaborActivePhaseVitalList>) => {
                ...
                this.unitService.get(response.unitId).then((unitresponse) => {
                    ...
                    for (let key in vitals) {
                        if (vitals.hasOwnProperty(key)) {
                            ...
                            if (vitals[key]) {
                                this.vitalListTime.push(moment(vitals[key].date).format("HH:mm:ss"));
    ...
    class Component implements ng.IComponentOptions {
        ...
        constructor(
            public templateUrl = "app/ui/widgets/temperature-graph/graph.html",
    ...
    app.component("mrsTemperatureGraph", new Component());
