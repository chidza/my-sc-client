namespace mrs.ui {
  ...
  class Controller implements IPersonDialog {
    ...
    static $inject = ["PersonService", "EducationLevelService",
      "OccupationService", "MaritalStateService"];
  ...
  class Component implements ng.IComponentOptions {
    ...
    constructor(
      public templateUrl = "app/ui/widgets/person/dialog.html",
  ...
  app.component("mrsPersonDialog", new Component());
