namespace mrs.ui {
  ...
  class Component implements ng.IComponentOptions {
    ...
    constructor(
      public templateUrl = "app/ui/widgets/essential-care-for-babies-investigation/dialog.html",
  ...
  app.component("mrsEssentialCareBabiesEncounterInvestigationDialog", new Component());
